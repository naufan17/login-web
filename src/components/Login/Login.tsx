            ...
            <div className="flex flex-col px-4 py-4 items-center justify-center">
                <div className="w-full sm:max-w-lg">
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="mb-2">
                            <label htmlFor="username" className="inline-block mb-1 font-medium text-sm sm:text-base text-gray-800">
                                Username
                            </label>
                            <input 
                                type="text" 
                        ...
                        <div className="mt-4">
                            <span className="flex justify-center mb-1 font-medium text-sm sm:text-base text-gray-800">
                                OR
                            </span>
                        </div>
                        <div className="mt-4">
                            <Link
                                to={'/register'}
                                className="inline-flex items-center justify-center w-full h-12 px-6 font-medium rounded-lg text-sm sm:text-base text-gray-800 bg-slate-200 hover:bg-slate-300"
                            > 
                                Register
                            </Link>
                        </div>
